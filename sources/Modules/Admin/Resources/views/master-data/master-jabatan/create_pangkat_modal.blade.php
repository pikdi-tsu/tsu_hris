<div class="modal-header text-white" style="background: linear-gradient(135deg, #094b54 0%, #0c6170 100%); padding: 1.1rem 1.4rem;">
    <h5 class="modal-title font-weight-bold" style="font-size: 1.05rem;">
        <i class="fas fa-plus-circle mr-2 text-warning"></i> Tambah Pangkat / Golongan
    </h5>
...
<form action="{{ route('admin.master-jabatan.pangkat.store') }}" method="POST">
    ...
    <div class="modal-body p-4">
        <div class="p-3 rounded mb-3" style="background: rgba(9, 75, 84, 0.05); border-left: 4px solid var(--tsu-primary, #094b54);">
            <div class="d-flex align-items-start">
                ...
                <div class="text-sm text-dark">
                    <b>Pangkat & Golongan:</b> Mengatur jenjang ruang pangkat pegawai (misal: Penata Muda / III a, Penata Muda Tk. I / III b, Pembina / IV a).
                </div>
            </div>
        </div>
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" name="nama_pangkat_golongan" class="form-control" required placeholder="Contoh: Penata Muda Tk. I / III b" style="border-radius: 8px;">
        </div>
