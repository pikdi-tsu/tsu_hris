...
@section('content')
            ...
            <div class="tsu-stat-grid-izin">
                ...
                <div class="tsu-stat-card tsu-stat-card--total">
                    <div class="tsu-stat-card__top">
                        <span class="tsu-stat-card__label">Total Master Izin</span>
                ...
                <div class="tsu-stat-card tsu-stat-card--pengajuan">
                    <div class="tsu-stat-card__top">
                        <span class="tsu-stat-card__label">Pengajuan Izin</span>
                        <div class="tsu-stat-card__icon-badge">
    ...
    <div class="modal fade" id="modal-izin" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-md modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg" id="modal-izin-content" style="border-radius: 12px; overflow: hidden;">
                {{-- Loaded via AJAX --}}
            </div>
        </div>
    </div>
        ...
        $(document).ready(function() {
            var table = $('#table-izin').DataTable({
                ...
                language: {
                    ...
                    emptyTable: "Tidak ada data jenis izin yang tersedia",
            ...
            $(document).on('submit', '#modal-izin form', function(e) {
                e.preventDefault();
                var $form = $(this);
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil!',
                            text: res.message || 'Data master izin berhasil disimpan.',
                            timer: 2000,
            ...
            $(document).on('click', '.btn-delete', function(e) {
                ...
                Swal.fire({
                    ...
                    html: "Anda akan menghapus jenis izin: <br><strong>" + rowName + "</strong>.<br><small class='text-danger'>Data yang dihapus tidak dapat dipulihkan!</small>",
                    icon: 'warning',
                        ...
                        $.ajax({
                            ...
                            success: function(res) {
                                ...
                                Swal.fire({
                                    icon: 'success',
                                    title: 'Terhapus!',
                                    text: res.message || 'Data master izin berhasil dihapus.',
                                    timer: 2000,
                                    showConfirmButton: false
                                });
                            },
