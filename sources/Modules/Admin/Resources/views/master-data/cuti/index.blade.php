...
@section('content')
    ...
    >
        <x-slot name="actions">
            @can('admin:master-cuti:create')
                <button type="button" class="btn btn-sm tsu-btn-primary-action btn-modal mr-2" data-url="{{ route('admin.master-cuti.create') }}" title="Tambah Jenis Master Cuti Baru">
            ...
            <div class="tsu-stat-grid-cuti">
                ...
                <div class="tsu-stat-card tsu-stat-card--total">
                    <div class="tsu-stat-card__top">
                        <span class="tsu-stat-card__label">Total Master Cuti</span>
                ...
                <div class="tsu-stat-card tsu-stat-card--aktif">
                    ...
                    <div class="tsu-stat-card__subtext">
                        Dapat Dipilih Pegawai Saat Pengajuan
                    </div>
                </div>
                ...
                <div class="tsu-stat-card tsu-stat-card--durasi">
                    <div class="tsu-stat-card__top">
                        <span class="tsu-stat-card__label">Maksimal Durasi</span>
                        <div class="tsu-stat-card__icon-badge">
    ...
    <div class="modal fade" id="modal-cuti" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-md modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg" id="modal-cuti-content" style="border-radius: 12px; overflow: hidden;">
                {{-- Loaded via AJAX --}}
            </div>
        </div>
    </div>
        ...
        $(document).ready(function() {
            var table = $('#table-cuti').DataTable({
                ...
                columns: [
                    ...
                    { data: 'durasicuti', name: 'durasicuti' },
                    { data: 'minimalhari', name: 'minimalhari' },
                ...
                language: {
                    ...
                    emptyTable: "Tidak ada data jenis cuti yang tersedia",
            ...
            $(document).on('submit', '#modal-cuti form', function(e) {
                e.preventDefault();
                var $form = $(this);
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil!',
                            text: res.message || 'Data master cuti berhasil disimpan.',
                            timer: 2000,
            ...
            $(document).on('click', '.btn-delete', function(e) {
                ...
                Swal.fire({
                    ...
                    html: "Anda akan menghapus kategori cuti: <br><strong>" + rowName + "</strong>.<br><small class='text-danger'>Data yang dihapus tidak dapat dipulihkan!</small>",
                    icon: 'warning',
                        ...
                        $.ajax({
                            ...
                            success: function(res) {
                                ...
                                Swal.fire({
                                    icon: 'success',
                                    title: 'Terhapus!',
                                    text: res.message || 'Data master cuti berhasil dihapus.',
                                    timer: 2000,
                                    showConfirmButton: false
                                });
                            },
