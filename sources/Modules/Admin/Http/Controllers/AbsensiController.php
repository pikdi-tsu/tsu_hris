...
class AbsensiController extends MiddlewareController
{
    ...
    public function index()
    {
        ...
        return view('admin::absensi.index', ['title' => 'Data Absensi', 'bulan' => $bulan]);
    }

    public function datatableabsensi()
    {
        $currentMonth = Carbon::now()->month;
        $currentYear = Carbon::now()->year;
        // dd($currentMonth, $currentYear);

        $data = DataAbsensi::where('periode_bulan', $currentMonth)->where('periode_tahun', $currentYear)->get();
