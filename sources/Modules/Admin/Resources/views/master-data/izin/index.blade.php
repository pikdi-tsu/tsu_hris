...
@section('content')
    <x-tsu-page-header
        ...
        subtitle="Kelola master jenis izin tidak masuk kerja dan dispensasi jam dinas pegawai"
        ...
        <div class="container-fluid">
            ...
            <div class="tsu-stat-grid-izin">
                ...
                <div class="tsu-stat-card tsu-stat-card--total">
                    <i class="fas fa-envelope-open-text tsu-stat-card__icon"></i>
                    <div>
                        <div class="tsu-stat-card__title">Total Master Izin</div>
                    ...
                    <div class="tsu-stat-card__subtext">
                        Kategori Izin Resmi di Lingkungan TSU
                    </div>
                </div>
                ...
                <div class="tsu-stat-card tsu-stat-card--nonaktif">
                    ...
                    <div class="tsu-stat-card__subtext">
                        Kategori Izin Dinonaktifkan
                    </div>
                </div>

                {{-- Total Pengajuan Terkait --}}
                <div class="tsu-stat-card tsu-stat-card--pengajuan">
                    <i class="fas fa-user-clock tsu-stat-card__icon"></i>
                    <div>
                        <div class="tsu-stat-card__title">Pengajuan Izin</div>
                        <div class="tsu-stat-card__value">
                    ...
                    <div class="tsu-stat-card__subtext">
                        Riwayat Permohonan Izin Pegawai
                    </div>
                </div>
            </div>
            ...
            <div class="card tsu-card">
                <div class="tsu-card__header d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        <h3 class="tsu-card__title">
                            <i class="fas fa-list-alt text-primary mr-2"></i>Daftar Master Jenis Izin Pegawai
                        </h3>
                        <p class="text-muted text-xs mb-0 mt-1">
                            Seluruh klasifikasi izin resmi yang dapat dipilih pada saat pengajuan izin pegawai
                        </p>
                    </div>
                </div>
                ...
                <div class="card-body p-3">
                    <div class="table-responsive">
                        <table id="table-izin" class="table tsu-table-modern table-hover w-100">
                            <thead>
                                <tr>
                                    <th width="5%" class="text-center">No</th>
                                    <th width="65%">Jenis Izin</th>
    ...
    <div class="modal fade" id="modal-izin" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-md modal-dialog-centered" role="document">
            <div class="modal-content" id="modal-izin-content" style="border-radius: 12px; overflow: hidden; border: none; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
                {{-- Loading State --}}
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#table-izin').DataTable({
                ...
                responsive: true,
                autoWidth: false,
                ajax: "{{ route('admin.master-izin.json') }}",
                language: dtLanguage,
                columns: [
            ...
            $('body').on('submit', '#modal-izin form', function(e) {
                e.preventDefault();
                var form = $(this);
            ...
            $('body').on('click', '.btn-delete', function(e) {
                ...
                Swal.fire({
                    title: 'Hapus Master Izin?',
                    html: "Anda akan menghapus jenis izin: <br><strong>" + rowName + "</strong>.<br><small class='text-danger font-weight-bold'>Data yang dihapus tidak dapat dipulihkan!</small>",
                    icon: 'warning',
