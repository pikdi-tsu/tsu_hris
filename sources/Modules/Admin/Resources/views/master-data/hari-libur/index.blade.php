...
@section('content')
    ...
    <x-tsu-page-header
        ...
        :icon="$menuIcon ?? 'far fa-calendar-alt'"
        :breadcrumb="true"
    >
        <x-slot name="actions">
            {{-- Tombol Tambah Libur Internal --}}
            @can('admin:hari-libur:create')
                <button type="button" class="btn btn-sm tsu-btn-primary-action btn-modal mr-2" data-url="{{ route('admin.hari-libur.create') }}" title="Tambah Hari Libur Khusus Institusi TSU">
